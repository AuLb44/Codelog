...
def crossmatch( kit101, kit10too, maxsepdist ):
  ...
  #   mindist = np.inf
  #   minid = None
  #   for id2, (alph2, olimar2) in enumerate( kit10too):
  #     angdist = angular_dist( alph2, olimar2, alph1, olimar1 )
  #     if angdist < mindist:
  #       minid = id2
  #       mindist = angdist 
  #   if mindist > maxrad:
  ...
  skykit101 = SkyCoord( kit101*u.degree, frame = 'icrs' )
  skykit10too = SkyCoord( kit10too*u.degree, frame = 'icrs' )
